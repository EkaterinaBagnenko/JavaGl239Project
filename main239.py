...
class MainWindow(QMainWindow):                                                                                                  
  ...
  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if(self.arrKnopok[0].isChecked() == True):
            ...
            for i in range(2, self.deskXL20.rowCount()):
                for j in range(0, 53):
                    a = get_column_letter(aa)
                    ss = a + str(kk)
                    if(self.deskXL20.item(i, j) is None):  
                        ws[ss] = None
                    else:
                        try:
                            ws[ss] = int(self.deskXL20.item(i, j).text())
                        except:
                            ws[ss] = self.deskXL20.item(i, j).text()
        ...
        if(self.arrKnopok[1].isChecked() == True):
            ...
            for i in range(2, self.deskXL21.rowCount()):
                for j in range(0, 53):
                    a = get_column_letter(aa)
                    ss = a + str(kk)
                    if(self.deskXL21.item(i, j) is None):  
                        ws[ss] = None
                    else:
                        try:
                            ws[ss] = int(self.deskXL21.item(i, j).text())
                        except:
                            ws[ss] = self.deskXL21.item(i, j).text()
        ...
        if(self.arrKnopok[2].isChecked() == True):
            ...
            for i in range(2, self.deskXL22.rowCount()):
                for j in range(0, 53):
                    a = get_column_letter(aa)
                    ss = a + str(kk)
                    if(self.deskXL22.item(i, j) is None):  
                        ws[ss] = None
                    else:
                        try:
                            ws[ss] = int(self.deskXL22.item(i, j).text())
                        except:
                            ws[ss] = self.deskXL22.item(i, j).text()
    ...
    def save2_was_clicked(self):
        print("save2_was_clicked")
