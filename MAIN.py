...
class MainWindow(QMainWindow):                                                                                                  
    ...
    arrExc1 = []                                                        # Массив элементов                                                                                                                                                                                         
    objects = []                                                        # Второй массив элементов

  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    def baseSetup(self):                                                # Настройки параметров основного окна                                                                        
    ...
    def constantLogo(self):                                             # Создание маленького логотипа                                                         
  ...
  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def mainRoomUser(self):                                             # Главное окно                                                                                                      
    ...
    def XXmainRoomUser(self):                                           # Скрытие виджетов главного окна                                                                                                  
        self.big_logo.hide()
        self.exc_archive.hide()
        self.exc_rec1.hide()
        self.exc_rec.hide()

    def goHome(self):                                                   # Кнопка перехода на главное окно                                                        
    ...
    def toHome_was_clicked(self):                                       # Реализация перехода на главное окно                                                            
        self.toHome.hide()
  ...
  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def exc_rec1_was_clicked(self):                                     # Окно архива
        self.XXmainRoomUser()
        self.goHome()
    ...
    def exc_2020_was_clicked(self):                                     # Архив за 2020
    ...
    def exc_2021_was_clicked(self):                                     # Архив за 2020
    ...
    def exc_2022_was_clicked(self):                                     # Архив за 2022
    ...
    def excyear_was_clicked(self):                                      # Архив итоговых таблиц
    ...
    def fill_the_table_2020(self):                                      # Заполнение таблицы
    ...
    def fill_the_table_2021(self):                                      # Заполнение таблицы
    ...
    def fill_the_table_2022(self):                                      # Заполнение таблицы    
    ...
    def fill_the_tableyear(self):                                       # Заполнение таблицы
    ...
    def hardfill_the_table_2020(self):                                  # Заполнение таблицы
    ...
    def hardfill_the_table_2021(self):                                  # Заполнение таблицы    
    ...
    def hardfill_the_table_2022(self):                                  # Заполнение таблицы
    ...
    def hardfill_the_tableyear(self):                                   # Заполнение таблицы
    ...
    def excTrouble(self):                                               # Вывод сообщения о невозможности открытия файла
        self.open_file.hide()                                                                                                       
    ...
    def open_file_was_clicked(self):                                    # Открыть файл
        name = self.texxt
        try:
    ...
    def excParcer0(self):                                               # Кнопка открытия
        self.open_file.show()  
        texxt1 = self.sender()
  ...
  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def exc_rec_was_clicked(self):                                      # Обновление архива
        self.XXmainRoomUser()
        self.goHome()
        self.name = ""
    ...
    def exc__2020_was_clicked(self):                                    # Наличие за 2020
    ...
    def exc__2021_was_clicked(self):                                    # Наличие за 2021
    ...
    def exc__2022_was_clicked(self):                                    # Наличие за 2022
    ...
    def exc__year_was_clicked(self):                                    # Наличие итоговых
    ...
    def fill_the_table_year(self):                                      # Заполнение таблицы
        newItem = QTableWidgetItem ('Итоговый 2020')
        newItem.setTextAlignment(Qt.AlignCenter)
        newItem.setFont(QFont('Corbel', 12))
    ...
    def fill_the_table__2020(self):                                     # Заполнение таблицы
        newItem = QTableWidgetItem ('Январь 2020')
        newItem.setTextAlignment(Qt.AlignCenter)
        newItem.setFont(QFont('Corbel', 12))
        self.table_Exc.setItem(0,0, newItem)
    ...
    def fill_the_table__2021(self):                                     # Заполнение таблицы
        newItem = QTableWidgetItem ('Январь 2021')
        newItem.setTextAlignment(Qt.AlignCenter)
        newItem.setFont(QFont('Corbel', 12))
        self.table_Exc.setItem(0,0, newItem)
    ...
    def fill_the_table__2022(self):                                     # Заполнение таблицы   
        newItem = QTableWidgetItem ('Январь 2022')
        newItem.setTextAlignment(Qt.AlignCenter)
        newItem.setFont(QFont('Corbel', 12))
        self.table_Exc.setItem(0,0, newItem)
    ...
    def hardfill_the_table__2020(self):                                 # Заполнение таблицы   
        arr_20n =[]
    ...
    def hardfill_the_table__2021(self):                                 # Заполнение таблицы
        arr_21n =[] 
    ...
    def hardfill_the_table__2022(self):                                 # Заполнение таблицы    
        arr_22n =[]
    ...
    def hardfill_the_table__year(self):                                 # Заполнение таблицы
        arr_yn =[]
    ...
    def obn_and_dob(self):                                              # Кнопка обновить
        self.obnov.show()
        self.dobav.hide()
        button = QApplication.instance().sender()
        self.name = button.objectName()

    def dob(self):                                                      # Кнопка добавить    
        self.obnov.hide()
        self.dobav.show()
        button = QApplication.instance().sender()
        self.name = button.objectName()

    def dobav_was_clicked(self):                                        # Добавление нового файла
    ...
    def obnov_was_clicked(self):                                        # Обновление текущего файла
        path = QFileDialog.getOpenFileName(self, filter="Excel (*.xlsx )")
        if(path[0] != ""):
            ppp = path[0]
            first= self.name[0:3]
  ...
  #-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def exc_archive_was_clicked(self):                                  # Переход на основное задание                                                                        
        self.XXmainRoomUser()
        self.goHome()

        self.start2task()

    def start2task(self):                                               # Создание всех необходимых виджетов       
        self.arrKnopok = []
    ...
    def deskXLZ(self):                                                  # Заполнение QTableWidget за 2020, 2021, 2022
    ...
    def save1_was_clicked(self):                                        # Сохранение получившихся таблиц
    ...
    def sbros_was_clicked(self):                                        # Сброс 
    ...
    def primenit_was_clicked(self):                                     # Начало решения    
        self.deskXL20.hide()
        self.deskXL21.hide()
        self.deskXL22.hide()
    ...
    def ttt2(self):                                                     # Парсинг для 2 варианта    
        nstr = 0
    ...
    def check(self):                                                    # Вспомогательный метод №1
        self.arr20path = []                                                                                                              
        self.arr21path = []                                                                                                             
        self.arr22path = []    
    ...
    def clear(self):                                                    # Вспомогательный метод №2
        for i in range (0, len(self.objects)):
            self.objects[i].hide()

    def interpreter(self, strk):                                        # Вспомогательный метод №3    
        if(strk == 'jan22.xlsx'):
            return 'Январь 2022'
        if(strk == 'feb22.xlsx'):
            return 'Февраль 2022'
